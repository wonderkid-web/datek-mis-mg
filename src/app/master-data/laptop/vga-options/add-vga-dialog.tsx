...
import { createVga } from "@/lib/vgaService";
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="outline">Add New VGA</Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Add New VGA Option</DialogTitle>
          <DialogDescription>
            Add a new VGA option to the list. Click save when you're done.
          </DialogDescription>
        </DialogHeader>
