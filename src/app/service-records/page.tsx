                ...
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            ...
                            <Select onValueChange={handleAssetSelect} value={assetAssignmentId?.toString() ?? ""}>
                                <SelectTrigger>
                        ...
                        <div>
                            ...
                            <Input id="ticketHelpdesk" value={ticketHelpdesk} onChange={(e) => setTicketHelpdesk(e.target.value)} />
                        </div>

                        <div>
                            <Label htmlFor="repairType">Repair Type</Label>
                            <Select onValueChange={(value: "SUPPLIER" | "INTERNAL") => setRepairType(value)} value={repairType}>
                                <SelectTrigger>
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                        ...
                        <div>
                            ...
                            <Input id="cost" value={cost} onChange={handleCostChange} placeholder="Rp 0" />
                        </div>
                        ...
                        <Table>
                            <TableBody>
                                ...
                                <TableRow>
                                    ...
                                    <TableCell>{selectedAssignment.user.departemen ?? 'N/A'}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell className="font-semibold">Company:</TableCell>
                                    <TableCell>{selectedAssignment.user.lokasiKantor ?? 'N/A'}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell className="font-semibold">Warranty End:</TableCell>
                                    <TableCell>{selectedAssignment.asset.tanggalGaransi ? new Date(selectedAssignment.asset.tanggalGaransi).toLocaleDateString() : 'N/A'}</TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
                    ) : (
