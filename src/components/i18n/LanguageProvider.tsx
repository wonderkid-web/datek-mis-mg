  ...
  id: {
    ...
    dashboard: {
      ...
      dialogs: {
        ...
        assetsByCategoryInCompany: "{category} di {company}",
        assetsByOperatingSystem: "Aset dengan OS {os}",
        ipInCompany: "IP Address di {company}",
        last30DaysRecords: "{label} — 30 hari terakhir",
      },
    },
  },
  en: {
    ...
    navbar: {
      ...
      nav: {
        ...
        "/data-center/ascend-assets": "Ascend Assets",
        "/data-center/assigned-assets": "Assigned Assets",
    ...
    dashboard: {
      ...
      dialogs: {
        ...
        assetsByCategoryInCompany: "{category} in {company}",
        assetsByOperatingSystem: "Assets with OS {os}",
        ipInCompany: "IP addresses in {company}",
        last30DaysRecords: "{label} — last 30 days",
      },
    },
  },
} as const;
